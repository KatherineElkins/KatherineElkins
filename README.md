...
**Computational Social Science + Humanities • AI Governance • Information Processing Research**
...
**Recognition**
- **Early GPT-3 researcher**: 2020 analysis ["Can GPT-3 Pass a Writer's Turing Test?"](https://gwern.net) archived on gwern.net
- **ICML contributor**: Publications at intersection of AI and social science

---

## 🏛️ Policy & Governance Engagement
...
- International Public AI - Co-author: ["If open source is to win, it must go public"](https://arxiv.org/abs/2507.09296)
...
- **[The Shapes of Cinderella: Emotional Architecture and the Language of Moral Difference](https://www.mdpi.com/2076-0787/14/10/198)** - *Humanities* (2025)
...
See full list: [Google Scholar](https://scholar.google.com/citations?user=bUSgS6IAAAAJ&hl=en) | [Digital Kenyon](https://digital.kenyon.edu/dh/)
...
**Teaching Philosophy**
"Active engagement over passive critique" - Enable students to conduct cutting-edge computational research that tests theories across social sciences and humanities. Result: Globally downloaded research with real-world applications.
...
- 🌐 Website: [katherineelkins.com](https://katherineelkins.com)
- 💼 LinkedIn: [Kate Elkins](https://www.linkedin.com/in/kate-elkins/)
- 📖 Google Scholar: [Profile](https://scholar.google.com/citations?user=bUSgS6IAAAAJ&hl=en)
- 🏛️ Institutional: [Kenyon College](https://www.kenyon.edu/directory/kate-elkins/)
- 📚 Digital Kenyon: [Research Repository](https://digital.kenyon.edu/dh/)
- 🐦 Twitter/X: [@katelelkins](https://twitter.com/katelelkins)
